...
define('DOMAIN_URL', 'https://admin.drive2mart.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'drive2mart0111'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_user = "drivey2m_admin";  // Change as required
    private $db_pass = "Drive2mart0111";  // Change as required
    private $db_name = "drivey2m_admin";    // Change as required
